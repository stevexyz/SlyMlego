...
def extract_features(board):
    ...
    if K.image_data_format() == "channels_last": # K.image_dim_ordering()=="tf"
        ...
        raise ValueError("Theano dimension ordering not implemented")
        exit(1)
    ...
    for m in board.generate_legal_moves():
        ...
        if piece == chess.Piece(chess.PAWN, chess.WHITE):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_white_pawns_moves] += 1
        elif piece == chess.Piece(chess.KNIGHT, chess.WHITE):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_white_knights_moves] += 1
        elif piece == chess.Piece(chess.BISHOP, chess.WHITE):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_white_bishops_moves] += 1
        elif piece == chess.Piece(chess.ROOK, chess.WHITE):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_white_rooks_moves] += 1
        elif piece == chess.Piece(chess.QUEEN, chess.WHITE):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_white_queens_moves] += 1
        elif piece == chess.Piece(chess.KING, chess.WHITE):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_white_king_moves] += 1
        else:
    ...
    for m in board.generate_legal_moves():
        ...
        if piece == chess.Piece(chess.PAWN, chess.BLACK):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_black_pawns_moves] += 1
        elif piece == chess.Piece(chess.KNIGHT, chess.BLACK):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_black_knights_moves] += 1
        elif piece == chess.Piece(chess.BISHOP, chess.BLACK):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_black_bishops_moves] += 1
        elif piece == chess.Piece(chess.ROOK, chess.BLACK):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_black_rooks_moves] += 1
        elif piece == chess.Piece(chess.QUEEN, chess.BLACK):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_black_queens_moves] += 1
        elif piece == chess.Piece(chess.KING, chess.BLACK):
            X[m.to_square % 8, int(m.to_square / 8), Const.X_black_king_moves] += 1
        else:
